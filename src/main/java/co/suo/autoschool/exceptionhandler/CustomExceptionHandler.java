...
public class CustomExceptionHandler {
    ...
    @ExceptionHandler(InvalidPasswordAccountException.class)
    public ResponseEntity<ErrorResponse> handleInvalidPasswordAccountException(InvalidPasswordAccountException exception) {
